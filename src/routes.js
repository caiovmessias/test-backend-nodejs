...
routes.get('/produtos', ProdutoController.index); // Listagem de todos os produtos
...
routes.get('/categorias', CategoriaController.index); //Listagem de todas as categorias
